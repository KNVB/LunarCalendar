 ...
 * @author Roy Tsang
 */
public class LunarCalendar_qq extends GregorianCalendar 
{
	...
	//===========================================================================================================================
	//	Constructor
	public LunarCalendar_qq()
	{
		super();
		init();
	}
	public LunarCalendar_qq(int year, int month, int date)
	{
		super();
		super.clear();
	...
	public LunarCalendar_qq(int year, int month, int date, int hour, int minute) 
	{
		super();
		super.clear();
		super.set(Calendar.YEAR,year);
	...
	public LunarCalendar_qq(int year, int month, int date, int hour, int minute, int second) 
	{
		super();
		super.clear();
		super.set(Calendar.YEAR,year);
	...
	public LunarCalendar_qq(Locale aLocale) 
	{
		super(aLocale);
		init();
	}
	public LunarCalendar_qq(TimeZone zone) 
	{
		super(zone);
		init();
	}
	public LunarCalendar_qq(TimeZone zone, Locale aLocale) 
	{
		super(zone, aLocale);
		init();
	}
	...
	public GregorianCalendar getEasterDateByYear(int y)
	{
		...
		LunarCalendar_qq ref=new LunarCalendar_qq(y,2,term2,0,0,0);//取得春分的國曆日期物件(春分一定出現在3月)
		//取得取得春分農曆
	...
	public static void main(String[] args) throws Exception
	{
		LunarCalendar_qq mc;
		if (args.length==0)
			mc=new LunarCalendar_qq();
		else	
			mc=new LunarCalendar_qq(Integer.valueOf(args[0]).intValue(),Integer.valueOf(args[1]).intValue()-1,Integer.valueOf(args[2]).intValue());
